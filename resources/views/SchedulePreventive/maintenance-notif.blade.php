                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">
                                        {{ \Carbon\Carbon::parse($schedule->scheduled_date)->diffInDays(now()) }} days left
                                    </p>
                                </div>
                            </div>
                        @endforeach
                    ...
                    @foreach($recentNotifications as $notif)
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 flex-1">
                                ...
                                <p class="text-sm font-medium text-gray-900 mt-1">{{ $notif->message }}</p>
                                <p class="text-xs text-gray-500 mt-1">{{ $notif->equipment_name }}</p>
                            </div>
                        </div>
                    @endforeach
    ...
    <div class="mt-6 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="text-center p-4 bg-green-50 rounded-lg">
                ...
                <p class="text-xs text-green-600 mt-1">✓ 100% target met</p>
            </div>
            <div class="text-center p-4 bg-blue-50 rounded-lg">
                <p class="text-2xl font-bold text-blue-600">15</p>
                <p class="text-sm text-gray-600 mt-1">Total Schedules</p>
                <p class="text-xs text-blue-600 mt-1">+20% vs last month</p>
            </div>
            <div class="text-center p-4 bg-purple-50 rounded-lg">
                <p class="text-2xl font-bold text-purple-600">85%</p>
                <p class="text-sm text-gray-600 mt-1">Equipment Uptime</p>
                <p class="text-xs text-purple-600 mt-1">Target: 90%</p>
            </div>
        </div>
    </div>
</div>
